...
#define SPI_CPHA_LOW   0   // Clock idle state = 0
#define SPI_CPHA_HIGH  1   // Clock idle state = 1

/* =================== SPI Slave Management =================== */
#define SPI_SSM_HW   1   // Hardware slave management (NSS pin used)
#define SPI_SSM_SW   0   // Software slave management (NSS handled by software)
