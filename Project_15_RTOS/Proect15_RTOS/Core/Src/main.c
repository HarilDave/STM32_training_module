...
//    for(;;)
//    {
//        sprintf(msg, "Task1 running\r\n");
//        HAL_UART_Transmit(&huart2, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
//        RGB_SetColor(1,0,0);
//        osDelay(TASK_DELAY_MS);
//
//        sprintf(msg, "Task2 running\r\n");
//        HAL_UART_Transmit(&huart2, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
//        RGB_SetColor(0,1,0);
//        osDelay(TASK_DELAY_MS);
//
//        sprintf(msg, "Task3 running\r\n");
//        HAL_UART_Transmit(&huart2, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
//        RGB_SetColor(0,0,1);
//        osDelay(TASK_DELAY_MS);
//    }
...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Multi-tasking RGB LED + UART console printing
  ******************************************************************************
  */
/* USER CODE END Header */
...
static void MX_GPIO_Init(void);
static void MX_USART2_UART_Init(void);
void Red_Task(void *argument);
void Green_Task(void *argument);
void Blue_Task(void *argument);
...
int main(void)
{
    ...
    RedTaskHandle = osThreadNew(Red_Task, NULL, &redTask_attributes);
    ...
    GreenTaskHandle = osThreadNew(Green_Task, NULL, &greenTask_attributes);
    ...
    BlueTaskHandle = osThreadNew(Blue_Task, NULL, &blueTask_attributes);
...
void Green_Task(void *argument)
{
    ...
    for(;;)
    {
        sprintf(msg, "Green Task running\r\n");
        HAL_UART_Transmit(&huart2, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
        RGB_SetColor(0,0,0);
        //osDelay(TASK_DELAY_MS);
        RGB_SetColor(0,1,0);
